...
<p><table>
  <thead>
    ...
    <tr>
      ...
      <a href="#system-information">ALS_data</a><br>
      <a href="#system-information">explain data structure</a><br>
             <a href="#virtual-box">modi operandi</a>
      </details></td>
      <td><a href="https://github.com/CBroemse/JSdbSTREAMall/files/7272490/outThere01Com.txt/">chars</a></td>
      <!------------------------------------------------------------------ Hub -->
    </tr>
    <tr>
      <td>
        <!------------------------------------------------------------------------------------------ Localhost port 3000 ---- vecClus01.j -->
        <a href="http://localhost:3000/" target="iframe_b">2-3-5</a>
      </td> 
      <td>
      <details> <summary>modulo</summary> 
             <a href="# the VectorClusTime">purpose</a><br>
	      <a href="#simulate">6er_rythm</a><br>
             <a href="file:///~./myprojects/proc1of2/DemoDeck7/PL%20-%20ClassicGui.html" target="_new">Goldbach</a><br>
             <a href="#abstract list'">Prime_binary_groups</a><br>
             </details>
      </td>    
      <td><details> <summary>load</summary> 
             <a href="http://localhost:3000/">write html</a><br>
             <a href="http://localhost:3000/">in browser</a><br>
             <a href="http://localhost:3000/">in  nodeJS</a><br>
             </details></td>
      <td>  <details> <summary>step_Function</summary> 
             <a href="#system-information">explain data structure</a><br>
             <a href="#virtual-box">modi operandi</a>
             </details></td>
      <!-- +++++++++++++++++++++++++++++++++++++
           ++++++++w+++++++++++++++++++++++++  link to issue txt-->
      <td><details> <summary>certain_points</summary> 
             <a href="#project-board-notes">project-board</a><br>
             <a href="#remote-to-git">issues</a><br>
      </details></td>
    </tr>
  </tbody>
  <tbody>
    <tr>
      ...
      <details> <summary></summary>        
             ...
             <a href="#delete-vs-truncate">energy/smoothness/...</a>
      </details>
      </td>
      <td>
     <details> <summary></summary>        
